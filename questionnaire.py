...
class Question:
    ...
    def from_json_data(data):
        # Tranform les donnees choix tuple (titre, bool "bonne reponse") -> [choix1, choix2....]
...
class Questionnaire:
    ...
    def from_json_data(data):
        ...
        #supprimer les question None (qui n'ont pas pu etre creer)
        question = [i for i in questions if i]
...
#Questionnaire.from_json_file("cinema_starwars_expert.json").lancer()
